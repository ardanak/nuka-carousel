...
var Carousel = _react2['default'].createClass({
  ...
  componentWillReceiveProps: function componentWillReceiveProps(nextProps) {
    this.setState({
      slideCount: nextProps.children.props.children.length
    });
  ...
  render: function render() {
    var self = this;
    var children = _react2['default'].Children.count(this.props.children.props.children) > 1 ? this.formatChildren(this.props.children.props.children) : this.props.children.props.children;
  ...
  goToSlide: function goToSlide(index) {
    var self = this;
    if (index >= _react2['default'].Children.count(this.props.children.props.children) || index < 0) {
      if (!this.props.wrapAround) {
        return;
      };
      if (index >= _react2['default'].Children.count(this.props.children.props.children)) {
        ...
        var endSlide = _react2['default'].Children.count(this.props.children.props.children) - this.state.slidesToScroll;
  ...
  nextSlide: function nextSlide() {
    var childrenCount = _react2['default'].Children.count(this.props.children.props.children);
    var slidesToShow = this.props.slidesToShow;
    if (this.props.slidesToScroll === 'auto') {
      slidesToShow = this.state.slidesToScroll;
    }
  ...
  setInitialDimensions: function setInitialDimensions() {
    ...
    this.setState({
      ...
      slideCount: _react2['default'].Children.count(this.props.children.props.children),
  ...
  getListStyles: function getListStyles() {
    var listWidth = this.state.slideWidth * _react2['default'].Children.count(this.props.children.props.children);
    var spacingOffset = this.props.cellSpacing * _react2['default'].Children.count(this.props.children.props.children);
